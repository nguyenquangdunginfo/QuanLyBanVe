...
namespace QuanLyBanVeMayBay
{
    public partial class frm_QuanlyNhanVien : Form
    {
        ...
        // biding load dữ liệu khi click chuột lên datagirdview  chọn sự kiên cellmouseclick
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            if (txt_manv.Text != "" && txt_tennv.Text != "") // mã nhân viên  không dc rỗng
            {
            ...
            dataGridView1.DataSource = ketnoi.ExecuteData("select * from NHANVIEN");// lòad lại dữ liệu mới khi them xong
        }
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Vui lòng nhập đầy đủ thông tin!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dataGridView1.DataSource = ketnoi.ExecuteData("select * from NHANVIEN");// load lại dữ liệu mới sau khi cập nhật
        }
